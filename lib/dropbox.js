...
_.extend( Dropbox.prototype, {
    ...
    _OAuthPost : function( uri, body, params, callback ) {
    ...
    */
    ...
    request_token : function( fn ) {
      this._OAuthPost("https://api.dropbox.com/1/oauth/request_token", "", function( err, parts ) {
        fn( err, querystring.parse( parts ));
      })
    },

    access_token : function( fn ) {

      this._OAuthPost("https://api.dropbox.com/1/oauth/access_token", "", function( err, parts ) {
        fn( err, querystring.parse( parts ));
      })
    },
